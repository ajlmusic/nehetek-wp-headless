...
function msbsbc_pdf_link_att($atts)
{
    ...
    return '<object class="w-full" data="' . $a['link'] . '" width="800" height="500"><span data-mce-type="bookmark" style="display: inline-block; width: 0px; overflow: hidden; line-height: 0;" class="mce_SELRES_start">﻿</span><span data-mce-type="bookmark" class="inline-block w-screen h-screen">﻿</span>Unable to display PDF file. <a href="' . $a['link'] . '">Download</a> instead. </object>';
}
